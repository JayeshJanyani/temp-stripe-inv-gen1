                    ...
                    <div className="flex justify-between gap-2 mr-10">
                        ...
                        <div className="flex gap-2">
                            ...
                            <Button type="button" onClick={()=>sendEmail()} className="bg-emerald hover:bg-emerald/80 text-white text-md px-5 flex items-center gap-2">
                                ...
                                Send Invoice</Button>
                            <Button type="button" onClick={()=>sendTempEmail()} className="bg-emerald hover:bg-emerald/80 text-white text-md px-5 flex items-center gap-2">Tempp send mail</Button>
                        </div>
                    </div>
